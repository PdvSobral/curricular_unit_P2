...
public class Database {
	...
	// maybe JSON?? or custom binary? or custom text with offsets
	...
	// Methods
	public void saveGame(Game game_to_save, String file_name){
		// Game is serialized
		// TODO: Ensure the file is writable
		try (FileOutputStream fileOut = new FileOutputStream(main_save_directory + "/" + games_save_subdirectory + "/" + file_name);
	...
	public void saveGame(Game game_to_save){
		...
		String filename = game_to_save.getYear() + "_" + gameName + ".gm";
	...
	public Game loadGame(String filename) {
		...
		File file = new File(main_save_directory + "/" + games_save_subdirectory + "/" + filename);
